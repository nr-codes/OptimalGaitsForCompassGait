...
cost[] := Module[{i, nqf, nqfv, nqfu, nqfub, fosim, u, uTBT, uin, cost, Mqd},
...
(* else *)
u = RigidBodyDynamics`Private`zq;
uTBT = RigidBodyDynamics`Private`zq;
];
...
uTBT = uTBT[[2;;nq]];
Mqd = Mqd[[2;;nq]];
uin = RigidBodyDynamics`Private`u[[2;;nq]];

cost = {u.u, uTBT.Mqd, uin.uin, uin.Mqd};
